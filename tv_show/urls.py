...
urlpatterns = [
    ...
    path('film_detail/<int:id>/delete/', views.DeleteTvShowView.as_view(), name='delete_film'),
    path('film_detail/<int:id>/update/', views.UpdateTvShowView.as_view(), name='update_film'),
